  ...
  return (
    <section id="about" className="text-white md:mt-96 py-16 px-6 md:px-12">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12">
          <div className="relative">
            <div className="absolute border-2 border-[#FBFF00] lg:w-32 w-40 h-10 md:h-12 left-10 top-1/2 -translate-y-1/2 z-0"></div>
        ...
        <div>
          <div className="relative">
            <div className="absolute border-2 border-[#FBFF00] lg:w-40 w-24 h-10 md:h-12 lg:left-16 left-16 top-1/2 -translate-y-1/2 z-0"></div>
            <h2 className="relative text-lg lg:text-2xl font-semibold mb-4 z-10 px-2">
              Why Choose Us
            </h2>
          </div>
