  ...
  return (
    <section id="about" className=" text-white md:mt-96 py-16 px-6 md:px-12">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="absolute border-2 border-white lg:w-56 w-40 h-9 lg:left-28 left-24 top-1/2 -translate-y-1/2 z-0"></div>
        <h2 className="relative text-lg lg:text-2xl text-[#FBFF00] font-semibold mb-4 z-10  px-2">
        ...
        {/* Intro text */}
        <p className="max-w-4xl text-gray-200 text-sm md:text-base leading-relaxed mb-12">
        ...
        <div className="relative">
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-200 text-sm md:text-base leading-relaxed">
            <li>
