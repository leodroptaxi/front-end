...
const Form = () => {
  ...
  const carTypes = [
    { type: 'Sedan', price: 14, model: '(₹14/km)', image: 'https://images.ctfassets.net/509kpi6dw56l/6QdZLGkGnMv0F8fDwFMGlE/1b85e10c7d90fdac89a4794938a43780/prime-play-1.png?h=250' },
    { type: 'Etios', price: 15, model: '(₹15/km)', image: 'https://images.ctfassets.net/509kpi6dw56l/7s8MKkYx4bSfPYlrqUEAW5/c23e3f9a5f9ebbbca681d63f0e8b8130/lux-1.png?h=250' },
    { type: 'MUV', price: 19, model: '(₹19/km)', image: 'https://images.ctfassets.net/509kpi6dw56l/72yoz2W0gPFPq50SfgPPqU/2c521cd2260cff9246ea2955bc37b707/prime-suv-1.png?h=250' },
...
${formData.trip_type === 'round_trip' ? `Return Date: ${formData.return_date}` : ''}
          ...
          <div className="bg-[#665c5c] text-white p-4 rounded-3xl shadow-2xl">
            ...
            <div className="mb-6">
              ...
              <div className="flex justify-center gap-16">
                <label className="flex items-start cursor-pointer">
                  ...
                  <span className={`ml-3  text-md font-medium  ${formData.trip_type === 'one_way'
                        ? 'text-yellow-500 '
                        : 'text-white' }`}>
                    ONE WAY
                    <br />
                ...
                <label className="flex items-start  cursor-pointer">
                  ...
                  <span className={`ml-3  text-md font-medium  ${formData.trip_type === 'round_trip'
                        ? 'text-yellow-500 '
                        : 'text-white' }`}>
                    ROUND TRIP
                    <br />
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div>
                ...
                />
                {errors.name && <span className="text-red-300 text-xs ml-2">{errors.name}</span>}
              </div>
              <div>
                <label htmlFor="mobile" className="block text-white text-xs font-medium mb-2">
            ...
            <div className="mb-6 ">
              ...
              <div className="grid grid-cols-2 pl-0 pr-14   gap-4">
                {carTypes.map((car) => (
                  ...
                  >
                    <img src={car.image} alt={car.type} className="w-full h-8 object-contain mb-2" />
          ...
          <div className="bg-gray-700 text-white p-6 rounded-3xl shadow-2xl text-center">
            ...
            <div className="bg-green-100 text-green-800 p-4 rounded-lg mb-6">
              <p className="text-xs font-medium">
                Your booking has been confirmed! You will receive booking details on WhatsApp shortly.
              </p>
            </div>
            <div className="bg-gray-600 rounded-lg p-4 mb-6 text-left text-xs">
              <div className="grid grid-cols-2 gap-2">
                ...
                <div className="col-span-2"><strong>Pickup:</strong> {formData.pickup}</div>
                <div className="col-span-2"><strong>Drop:</strong> {formData.drop}</div>
                <div><strong>Date:</strong> {formData.pickup_date}</div>
                <div><strong>Time:</strong> {formData.pickup_time}</div>
                <div><strong>Car:</strong> {formData.selectedCarType}</div>
                <div><strong>Fare:</strong> ₹{estimationData.cost}</div>
              </div>
            </div>
            <p className="text-xs mb-6 opacity-90">
              Thanks for choosing <strong>Leo Drop Taxi</strong>! For any queries, contact: <strong>+91 9486891950</strong>
            </p>
